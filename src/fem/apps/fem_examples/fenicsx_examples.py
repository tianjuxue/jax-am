...
def get_dog_bone_file_path(file_type, index):
    ...
    xdmf_root = f"src/fem/apps/fem_examples/data/xdmf" 
...
def get_cylinder_file_path():
    return f"src/fem/data/msh/cylinder.xdmf"
...
def performance_test():
    ...
    np.savetxt(f"src/fem/apps/fem_examples/data/txt/fenicsx_fem_time.txt", solve_time, fmt='%.3f')
...
def generate_fem_examples():
    ...
    np.save(f'src/fem/apps/fem_examples/data/numpy/linear_elasticity/fenicsx/disps.npy', linear_elasticity_disps)
    np.save(f'src/fem/apps/fem_examples/data/numpy/linear_elasticity/fenicsx/forces.npy', tractions)
    ...
    for disp in hyperelasticity_disps:
        ...
        tractions.append(traction)
    tractions = np.array(tractions)
    np.save(f'src/fem/apps/fem_examples/data/numpy/hyperelasticity/fenicsx/disps.npy', hyperelasticity_disps)
    np.save(f'src/fem/apps/fem_examples/data/numpy/hyperelasticity/fenicsx/forces.npy', tractions)
