...
def load_data():
    file_path = f"modules/fem/apps/multi_scale/data/numpy/training"
...
def get_path_pickle(hyperparam):
    root_pickle = f"modules/fem/apps/multi_scale/data/pickle"
...
def get_path_loss(hyperparam):
    root_loss = f"modules/fem/apps/multi_scale/data/numpy/training/losses"
...
def get_root_pdf():
    root_pdf = f"modules/fem/apps/multi_scale/data/pdf/training"
