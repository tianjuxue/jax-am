...
from modules.fem.solver import solver, assign_bc, get_A_fn_linear_fn
from modules.fem.utils import save_sol
from modules.fem.apps.multi_scale.utils import flat_to_tensor
...
def exp():
    ...
    jax_vtu_path = f"modules/fem/apps/multi_scale/data/vtk/{problem.name}/sol_disp_ini.vtu"
    ...
    jax_vtu_path = f"modules/fem/apps/multi_scale/data/vtk/{problem.name}/sol_fluc.vtu"
...
def collect_data():
    ...
    root_vtk = os.path.join(f"modules/fem/apps/multi_scale/data/vtk/training", date)
