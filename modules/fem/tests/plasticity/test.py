...
import meshio
import unittest
from modules.fem.jax_fem import Mesh, Plasticity
...
class Test(unittest.TestCase):
    ...
    def test_solve_problem(self):
        ...
        fenicsx_vtu_path_raw = f"modules/fem/tests/{problem_name}/fenicsx/sol_p0_000000.vtu"
        fenicsx_vtu_path = f"modules/fem/tests/{problem_name}/fenicsx/sol.vtu"
        ...
        disps = np.load(f"modules/fem/tests/{problem_name}/fenicsx/disps.npy")
        ...
        jax_vtu_path = f"modules/fem/tests/{problem_name}/jax_fem/sol.vtu"
        ...
        fenicsx_avg_stresses = np.load(f"modules/fem/tests/{problem_name}/fenicsx/avg_stresses.npy")
        jax_fem_avg_stresses = avg_stresses[:, 2, 2]
        np.save(f"modules/fem/tests/{problem_name}/jax_fem/avg_stresses.npy", jax_fem_avg_stresses)
